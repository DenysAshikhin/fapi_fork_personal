...
import lockedAssembly from '../assets/images/assembly/Not_Unlocked.png';
...
const AssemblyInnerBonus = ({ line, al_level }) => {
        ...
        >
            ...
            >
                {assembly.BonusList.map((e, inner_index) => {
                    return <AssemblyInnerBonus line={e} al_level={assembly.Level} />
                })}
